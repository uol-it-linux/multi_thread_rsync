...
for i in "${!user_dirs[@]}"; do
  ...
  echo -e ln -s "/uolstore/home/staff_lnxhome01/${user_dirs[$i]}" "/home/csunix/${user_dirs[$i]}" >> /root/symlink.log
    ln -s "/uolstore/home/staff_lnxhome01/${user_dirs[$i]}" "/home/csunix/${user_dirs[$i]}"
  else
